    ...
    <section className="py-16 bg-muted/50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">Faça Parte do Nosso Marketplace</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-2xl font-bold mb-4">Sou Lojista</h3>
              <p className="text-muted-foreground mb-6">
                Cadastre seu estabelecimento e comece a vender online. 
                Gerencie produtos, pedidos e aumente suas vendas.
              </p>
