		...
		<section className='relative bg-gradient-hero py-20 overflow-hidden'>
			...
			<div className='container mx-auto px-4 relative'>
				<div className='text-center mb-12'>
					...
					<p className='text-xl text-muted-foreground max-w-2xl mx-auto text-'>
				...
				<div className='max-w-4xl mx-auto'>
					<div className='bg-background/90 backdrop-blur-sm rounded-2xl border shadow-primary p-6'>
						...
						<Button
							size='lg'
							className='w-full mt-4 h-12 text-base bg-gradient-primary hover:opacity-90 shadow-primary'
						>
