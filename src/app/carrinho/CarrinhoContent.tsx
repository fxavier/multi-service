...
export default function CarrinhoContent() {
  const { itens, removerItem, atualizarQuantidade, subtotal, limparCarrinho } = useCarrinho();

  // Agrupar itens por merchant/prestador
  ...
  const taxaEntrega = 5.99; // Taxa fixa para exemplo
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          {Object.entries(itensAgrupados).map(([grupoId, itensGrupo]) => {
            ...
            const nomeGrupo = merchant?.nome || prestador?.nome || 'Outros';
